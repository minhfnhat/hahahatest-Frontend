            ...
            <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
              <div className="mx-auto max-w-2xl lg:mx-0">
                ...
                <h1 className="mt-24 text-4xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">
                  Enhance Your Work-Life Harmony with Work Likfe
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Work Likfe is crafted to resolve the common pain points in managing work and personal life, delivering an organized and stress-free lifestyle for its users. Unlike competitors, Work Likfe simplifies the complicated aspects of balancing work responsibilities and personal well-being, saving you time, effort, and money.
                </p>
